...
# Q6.a: How does intrinsic change before and after the scaling? You only need to modify K1 and K2 here, if necessary.
# If you think they remain the same, leave here as blank and explain why. --------------------------- Begin your code
# here ---------------------------------------------
